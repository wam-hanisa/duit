...
const toolMap = {
  ...
  update_config: ({ changes, reason = "" }) => {
    ...
    const CONFIG_MAP = {
      ...
      solMomentumCheckEnabled: ["management", "solMomentumCheckEnabled"],
      solMomentumSkipDropPct: ["management", "solMomentumSkipDropPct"],
      solMomentumCautionDropPct: ["management", "solMomentumCautionDropPct"],
